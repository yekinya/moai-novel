...
| `chapter1/02-part-2.md` | ✍️ DRAFT (분할 보류) | 16,029자 | 떠돌이의 길 (Ch1 P2) — 8회차 1.5-1~1.5-8 정합 v3 — 사용자 보강: 1.5-6 길드 인물 3인 노하우 견식 + 오크 분쟁지 청등급 의뢰 (고전) — 사용자 정통: 분량 그대로 유지·향후 일괄 분할 작업 예정 |
