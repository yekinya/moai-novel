...
| `chapter1/02-part-2.md` | ✍️ DRAFT | 11,716자 | 떠돌이의 길 (Ch1 P2) — 8회차 1.5-1~1.5-8 정합 v2 (사용자 1.5-3 재작성 요구 매개 — 객점 도적 8인 폐기·엘 술자리·솔직 대화·모험가 길드·6개월 동행·1년 홀로 분량 추가로 분량 초과·사용자 확인 대기) |
