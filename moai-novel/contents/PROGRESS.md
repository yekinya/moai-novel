...
| `chapter1/02-part-2.md` | ✍️ DRAFT (분할 보류) | 17,484자 | 떠돌이의 길 (Ch1 P2) — 8회차 1.5-1~1.5-8 정합 v4 — 사용자 보강: 엘 2년차·한 살 어림·파란 눈, 분소장 *노른* 본명, 마수 부산물 생태 정통 (도감 sync), 1.5-6 잡일 단편 생태. 분량 그대로 유지·향후 일괄 분할 |
...
| 2026-06-02 | `chapter1/02-part-2.md` | 1.5-3 재작성 (도적 8인 폐기·엘 술자리·잔향 솔직 대화·모험가 길드) + 1.5-4 모험가 길드 첫 의뢰 신규 + 1.5-5 6개월 동행 신규 + 1.5-6 홀로 일 년 신규 + 1.5-7/1.5-8 회차 이동 (사용자 정합) — 분량 11,716자로 HARD 8,000±500 초과 (사용자 확인 대기) | MoAI |
| 2026-06-02 | style-guide §6.1d + PROGRESS | 분량 초과 잠정 허용·향후 일괄 분할 정통 신설 (사용자 정의) — Part 2 그대로 유지 | MoAI |
| 2026-06-02 | `chapter1/02-part-2.md` 1.5-6 | 사용자 보강: 길드 인물 3인 노하우 견식 (라젠 다섯 점 모으기·도리 명치 시작·마릿 약초 일곱 종) + 오크 분쟁지 청등급 의뢰 (분소장·정찰병 3·본대 6·부족 전사 1 안면 분사 튕김·갈비뼈 2대·검 두 동강·안개 다섯 점 폭발·보수 절반·약초 추가 한 종) — 분량 11,716 → 16,029자 (HARD 초과·사용자 정통대로 그대로 유지) | MoAI |
| 2026-06-02 | `chapter1/02-part-2.md` 1.5-3·1.5-4 + 신규 도감 | 사용자 정합: 엘 *2년 차·카엘보다 한 살 어림·파란 눈·독특한 매력* + 분소장 *노른* 본명 정합 + 1.5-4 마수 부산물 정통 명시 (풀무늘대·검은 늪 곰·송곳니·발톱·가죽 매개) + 1.5-6 잡일 단편 생태 명시 (거미 떼·고블린·트롤). 신규 도감 `world/15-생물과-생태.md` 생성 — 분량 16,029 → 17,484자 (HARD 초과·사용자 정통 유지) | MoAI |
| 2026-06-03 | `chapter1/02-part-2.md` + 도감 + spec | 카르엔 명명 정합 (사용자 지적): 본문/도감/spec의 변경 정착지 카랜 → 카르엔 일괄 통일 (spec 정통 *카르엔 = 변경 시장 마을* 매개). 8건 sed 변환 (본문 5·spec 2·도감 1) | MoAI |
